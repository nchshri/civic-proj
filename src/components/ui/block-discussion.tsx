...
import { commentPlugin } from '@/src/components/editor/plugins/comment-kit';
import {
  type TDiscussion,
  discussionPlugin,
} from '@/src/components/editor/plugins/discussion-kit';
import { suggestionPlugin } from '@/src/components/editor/plugins/suggestion-kit';
